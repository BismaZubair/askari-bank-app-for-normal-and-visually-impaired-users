...
// ================================================
// MY PROFILE JS - WITH ASSISTPAY TOGGLE
// ================================================
...
function displayUserName() {
    ...
    if (user && userNameSpan) {
        ...
        console.log("Name set to:", userNameSpan.textContent);
...
function initDirectClicks() {
    ...
    items.forEach(item => {
        ...
        item.removeEventListener("click", initDirectClicks.handler);
        ...
        initDirectClicks.handler = handler;
    });
}
async function runWelcome() {
    ...
    await speak("Profile page. Welcome, " + userName + ". Your personal settings options are: " + labels.join(". ") + ". Triple tap on any option to hear its name. Single tap to select and open it.");
    welcomeDone = true;
}
